...
(async () => {
  ...
  try {
    ...
    const checks = await page.evaluate(async () => {
      ...
      removeBgButton.click(); const firstCutout = getImageSource(item);
      ...
      const bounds = getBaseLayerRect(item); removeBgButton.click(); removeBgButton.click();
      ...
      await addLayerImages([await asFile(light, 'light layer.png')]); removeBgButton.click();
